...
void APhysicsTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void APhysicsTestCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool APhysicsTestCharacter::GetHasRifle()
{
	return bHasRifle;
}